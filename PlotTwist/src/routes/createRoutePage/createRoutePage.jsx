...
export default function CreateRoutePage() {
  ...
  return (
    <>
      <Header />
      <main className="mainCreateRoutePage">
        <div className="createRoute__OpeningParas">
          {changeOpeningPara ? (
            <h2>
              Welcome to U-PLOT! <br /> You will be able to plan routes simply
              and easily
            </h2>
          ) : (
          ...
          <br />
          <h2>
            Start by clicking your start and end points, then add any other
            stops along the way
          </h2>
        </div>
